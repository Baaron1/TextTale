...
time.sleep(2)
print("Sans: hey, take it easy. i've gotten a {0}ton{1} of work done today.").format(fg('yellow'), attr(0))
time.sleep(2)
print("Sans: a skele-{0}ton{1}.".format(fg('yellow'), attr(0)))
time.sleep(2)
print("Papyrus: SANS!!!")
time.sleep(2)
...
time.sleep(2)
print("Sans: down to the {0}bone.{1}".format(fg('yellow'), attr(0)))
time.sleep(2)
